...
class PhpExtension
{
    ...
    /**
     * @param $phpVersion string version of PHP
     * @param $onlyDefaults bool only install default extensions
     * @return void
     */
    public function installExtensions(string $phpVersion, bool $onlyDefaults = true): void
    {
     ...
     *
     * @param $extension string extension key name
     * @param $phpVersion string version of PHP
     * @return bool
     */
    public function installExtension(string $extension, string $phpVersion): bool
    {
    ...
    /**
     * Uninstall all extensions for a specific PHP version.
     *
     * @param $phpVersion
     * @param $phpIniConfigPath
     */
    public function uninstallExtensions($phpVersion, $phpIniConfigPath): void
    {
